...
namespace EAgenda.ModuloCompromisso
{
    public class TelaCadastroCompromisso : TelaBase
    {
        ...
        public Contato ObterContato()
        {
            ...
            {
                notificador.ApresentarMensagem("Cadastre um contato antes de um compromisso!", TipoMensagem.Atencao);
                return null;
            }

            int numContatoSelecionado = MetodosAuxiliares.ValidarInputInt("Digite o ID: ");
        ...
        public int ObterNumeroRegistro()
        {
            ...
            do
            {
                ...
                if (numeroRegistroEncontrado == false)
                    notificador.ApresentarMensagem("ID não foi encontrado, tente novamente.", TipoMensagem.Atencao);
